...
export default {
  ...
  methods: {
    ...
    onRegister () {
      let usernameResult = this.validUsername(this.register.username)
      if (!usernameResult.isValid) {
        this.register.isError = true
        this.register.notice = usernameResult.notice
        return
      }
      let passwordResult = this.validPassword(this.register.password)
    ...
    onLogin () {
      ...
      let passwordResult = this.validPassword(this.login.password)
      if (!passwordResult.isValid) {
        this.login.isError = true
